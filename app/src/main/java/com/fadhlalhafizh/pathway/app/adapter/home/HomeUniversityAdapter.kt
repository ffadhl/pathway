...
import com.fadhlalhafizh.pathway.app.ui.detailuniversity.detailuniversityhome.DetailUniversityHomeActivity
import com.fadhlalhafizh.pathway.data.model.University

class HomeUniversityAdapter(private val listUniversity: ArrayList<University>): RecyclerView.Adapter<HomeUniversityAdapter.MyViewHolder>() {
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        holder.itemView.setOnClickListener {
            val intentDetail = Intent(holder.itemView.context, DetailUniversityHomeActivity::class.java)
